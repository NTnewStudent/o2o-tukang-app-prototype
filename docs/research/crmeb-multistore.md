# CRMEB multi-store (多商户) research

**Product:** CRMEB 多商户 PHP — B2B2C + O2O multi-merchant commerce suite  
**Vendor:** 西安众邦网络科技 / crmeb.com (docs at [doc.crmeb.com](https://doc.crmeb.com/mer/mer3_1))  
**Demo:** [mer.crmeb.net](http://mer.crmeb.net)  
**Stack (vendor):** ThinkPHP 6 + Swoole 4 + uni-app; H5 / WeChat mini-program / App / PC  
**Brief context:** “O2O mall side conceptually based on **CRMEB multi-store latest** secondary development.” This note extracts the **commerce patterns** we reuse, not a license to ship CRMEB source.
